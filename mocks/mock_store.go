...
func (m *MockBookStore) IsExist(ctx *krogo.Context, id *uuid.UUID, regNum *string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsExist", ctx, id, regNum)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBookStoreMockRecorder) IsExist(ctx, id, regNum interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsExist", reflect.TypeOf((*MockBookStore)(nil).IsExist), ctx, id, regNum)
}
